...
import com.nttdata.repositories.ProductosRepository;
...
public class ProductoController {
    ...
    public String mostrarFormularioEditar(@PathVariable int id, Model model) {
        model.addAttribute("producto", productosRepository.findFirstByCodigo(id).orElse(null));
        return "productos/editar_producto";
    }
    ...
    public String guardarProducto(@ModelAttribute @Valid Producto producto, BindingResult bindingResult, RedirectAttributes redirectAttrs) {
        ...
        if (productosRepository.findFirstBy(producto.getCodigo()) != null) {
            redirectAttrs
                    .addFlashAttribute("mensaje", "Ya existe un producto con ese código")
                    .addFlashAttribute("clase", "warning");
            return "redirect:/productos/agregar";
