...
import cl.nttdata.petclinic.service.PetService;
...
/**
 * REST controller for managing {@link cl.nttdata.petclinic.domain.Pet}.
 */
@RestController
@RequestMapping("/api")
public class PetResource {
     ...
     */
    @GetMapping("/pets")
    public ResponseEntity<List<PetDTO>> getAllPets(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
