...
/**
 * REST controller for managing {@link cl.nttdata.petclinic.domain.Visit}.
 */
@RestController
@RequestMapping("/api")
public class VisitResource {
     ...
     */
    @GetMapping("/visits")
    public ResponseEntity<List<VisitDTO>> getAllVisits(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
