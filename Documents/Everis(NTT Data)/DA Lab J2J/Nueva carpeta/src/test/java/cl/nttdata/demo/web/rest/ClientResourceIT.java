package cl.nttdata.demo.web.rest;
...
import cl.nttdata.demo.IntegrationTest;
import cl.nttdata.demo.domain.Address;
import cl.nttdata.demo.domain.Client;
import cl.nttdata.demo.repository.ClientRepository;
import cl.nttdata.demo.service.dto.ClientDTO;
import cl.nttdata.demo.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    private static final Long DEFAULT_CELLPHONE_NUMBER = 1L;
    private static final Long UPDATED_CELLPHONE_NUMBER = 2L;
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            ...
            .cellphoneNumber(DEFAULT_CELLPHONE_NUMBER)
            .email(DEFAULT_EMAIL);
        // Add required entity
        Address address;
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            ...
            .cellphoneNumber(UPDATED_CELLPHONE_NUMBER)
            .email(UPDATED_EMAIL);
        // Add required entity
        Address address;
        if (TestUtil.findAll(em, Address.class).isEmpty()) {
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getAddressName()).isEqualTo(DEFAULT_ADDRESS_NAME);
        assertThat(testClient.getCellphoneNumber()).isEqualTo(DEFAULT_CELLPHONE_NUMBER);
    ...
    void checkCellphoneNumberIsRequired() throws Exception {
        int databaseSizeBeforeTest = clientRepository.findAll().size();
        // set the field null
        client.setCellphoneNumber(null);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].cellphoneNumber").value(hasItem(DEFAULT_CELLPHONE_NUMBER.intValue())))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.cellphoneNumber").value(DEFAULT_CELLPHONE_NUMBER.intValue()))
    ...
    void putNewClient() throws Exception {
        ...
        assertThat(testClient.getAddressName()).isEqualTo(UPDATED_ADDRESS_NAME);
        assertThat(testClient.getCellphoneNumber()).isEqualTo(UPDATED_CELLPHONE_NUMBER);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).addressName(UPDATED_ADDRESS_NAME);
